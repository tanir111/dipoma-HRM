        ...
        <div class="topbar-left">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-link">
                    <a href=""> {{trans('messages.assigned_assets')}} </a>
                </li>
                <li class="breadcrumb-current-item"> {{trans('messages.assignment_listings')}} </li>
            </ol>
        </div>
    </header>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <span class="panel-title hidden-xs"> {{trans('messages.asset_assignment_listings')}} </span>
                        </div>
                        <div class="panel-body pn">
                            ...
                            <div class="table-responsive">
                                <table class="table allcp-form theme-warning tc-checkbox-1 fs13">
                                    ...
                                    <th class="text-center">{{trans('messages.asset')}}</th>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group text-right">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li>
                                                        <a href="/edit-asset-assignment/{{$asset->id}}">{{trans('messages.edit')}}</a>
                                                    </li>
                                                    <li>
                                                        <a href="/delete-asset-assignment/{{$asset->id}}">{{trans('messages.delete')}}</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
