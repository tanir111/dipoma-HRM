        ...
        <header id="topbar" class="alt">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-current-item"> {{trans('messages.awards_listings')}} </li>
                </ol>
            </div>
        </header>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <span class="panel-title hidden-xs"> {{trans('messages.award_lists')}} </span>
                            </div>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group text-right">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                            <li>
                                                                <a href="/edit-award/{{$award->id}}">{{trans('messages.edit')}}</a>
                                                            </li>
                                                            <li>
                                                                <a href="/delete-award/{{$award->id}}">{{trans('messages.delete')}}</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </td>
