    ...
    <div class="content">
        ...
        <header id="topbar" class="alt">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-current-item"> {{trans('messages.meetings')}} </li>
                </ol>
            </div>
        </header>
        <!-- -------------- /Topbar -------------- -->
        ...
        <section id="content" class="animated fadeIn">
            ...
            <div class="chute chute-center ph45">
                ...
                <h2 class="text-muted" style="text-align:center"> {{trans('messages.schedule_meetings')}}
                        ...
                        <div class="col-md-12">
                            <label for="firstname" class="field prepend-icon">
                                <select id="meeting_attendees" class="form-control" multiple required>
                                    <option disabled>Meeting Attendees</option>
