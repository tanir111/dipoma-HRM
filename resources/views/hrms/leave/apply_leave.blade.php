        ...
        <header id="topbar" class="alt">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-current-item"> {{trans('messages.apply_leave')}}</li>
                </ol>
            </div>
        </header>
        <!-- -------------- Content -------------- -->
                        ...
                        <div class="box box-success">
                            <div class="panel">
                                <div class="panel-heading">
                                    <span class="panel-title hidden-xs">{{trans('messages.apply_for_leave')}}</span>
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <div class="panel-body p25 pb10">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-2 control-label"> {{trans('messages.leave_type')}} </label>
                                                <div class="col-md-10">
                                            ...
                                            <div class="form-group">
                                                <label for="date_from"
                                                       class="col-md-2 control-label"> {{trans('messages.date_from')}} </label>
                                                <div class="col-md-3">
                                                ...
                                                <label for="date_to"
                                                       class="col-md-2 control-label">{{trans('messages.date_to')}} </label>
                                                <div class="col-md-3">
                                                    <div class="input-group">
                                                        <div class="input-group-addon">
                                                            <i class="fa fa-calendar text-alert pr10"></i>
                                            ...
                                            <div class="form-group">
                                                <label for="time_from"
                                                       class=" col-md-2 control-label  "> {{trans('messages.time_from')}} </label>
                                                <div class="col-md-3">
                                                    <div class="input-group">
                                                        <div class="input-group-addon">
                                                ...
                                                <label for="time_to"
                                                       class="col-md-2 control-label"> {{trans('messages.time_to')}} </label>
                                                <div class="col-md-3">
                                                    <div class="input-group">
                                                        <div class="input-group-addon">
                                                            <i class="imoon imoon-clock text-alert pr10"></i>
                                                        ...
                                                        <input type="text" id="timepicker4"
                                                               class="select2-single form-control" value="18:00"
                                            ...
                                            <div class="form-group">
                                                <label for="input002"
                                                       class="col-md-2 control-label"> {{trans('messages.days')}} </label>
                                                <div class="col-md-10">
                                            ...
                                            <div class="form-group">
                                                <label for="input002"
                                                       class="col-md-2 control-label"> {{trans('messages.reason')}} </label>
                                                <div class="col-md-10">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2"><a href="/apply-leave">
                                                        <input type="button"
                                                               ...
                                                               value="{{trans('messages.reset')}}"></a></div>
