        ...
        <header id="topbar" class="alt">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-current-item"> {{trans('messages.add_holiday')}}</li>
                </ol>
            </div>
            <div class="topbar-right">
                <h4><a class="link-unstyled" href="/sample_sheet/Holiday_sample_sheet.xlsx" title="">
                        <i class="fa fa-cloud-download text-purple pr10"></i> {{trans('messages.sample_sheet')}} </a>
                </h4>
            </div>
        </header>
        <!-- -------------- Content -------------- -->
                                    ...
                                    <div class="panel-body pn mv12">
                                        ...
                                        <div class="section">
                                            <label for="username" class="field prepend-icon">
                                                <h6> {{trans('messages.description')}} </h6></label>
                                        ...
                                        <div class="section">
                                            <div class="input-group">
                                                <label for="date" class="field prepend-icon ">
                                                    <h6> {{trans('messages.select_date')}} </h6></label>
                                                <input type="text" id="datepicker1"
                                                       class="gui-input fs13 select2-single form-control" name="date"
                                                       required>
                                            </div>
                                        </div>

                                        <div class="section">
                                            <label for="file1"><h6> {{trans('messages.upload_file')}}</h6></label>
